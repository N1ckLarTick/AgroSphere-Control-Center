...
public final class DeviceItemBinding implements ViewBinding {
  ...
  private DeviceItemBinding(@NonNull CardView rootView, @NonNull TextView deviceName,
      @NonNull TextView devicePin, @NonNull TextView deviceType) {
  ...
  public static DeviceItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DeviceItemBinding((CardView) rootView, deviceName, devicePin, deviceType);
    }
